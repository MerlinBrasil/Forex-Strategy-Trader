...
namespace MT4Bridge.NamedPipes
{
    ...
    internal sealed class NamedPipeNative
    {
        ...
        /// <see cref="MT4Bridge.NamedPipes.SECURITY_ATTRIBUTES">SECURITY_ATTRIBUTES</see> 
        ...
        /// <see cref="MT4Bridge.NamedPipes.Overlapped">Overlapped</see> object.</param>
        /// <returns>If the function succeeds, the return value is nonzero.</returns>
        #endregion
        [DllImport("kernel32.dll", SetLastError=true)]
        public static extern bool ConnectNamedPipe(
            IntPtr hHandle,								// handle to named pipe
            [In] ref NativeOverlapped lpOverlapped		// overlapped structure
            );
        [DllImport("kernel32.dll", SetLastError=true)]
        ...
        /// <see cref="MT4Bridge.NamedPipes.SecurityAttributes">SecurityAttributes</see> 
